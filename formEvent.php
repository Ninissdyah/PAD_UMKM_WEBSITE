...
<body>
    ...
    <section class="form">
        ...
        <h3 class="text-center mb-5"> Event </h3>
            <form name="formEvent" action="" method="post">
                ...
                <br>
                <div class="form-group">
                    <input type="text" class="form-control" name="namaEvent" placeholder="Event Name" required="">
                </div>
                <br>
                <div class="form-group">
                    <input type="text" class="form-control" name="linkEvent" placeholder="Link Event" required="">
                </div>
                <br>
                ...
                <br>
                <input type="submit" class="btn px-5" name="submit" value="Save" style="font-size: 16px; float: right; display:block; background: #5DCAA0; font-weight:700; border-radius: 20px;">
            </form>
        </div>
    </section>
    <!-- FORM EVENT AKHIR -->
